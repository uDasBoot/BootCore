...
@OnlyIn(Dist.CLIENT)
public abstract class AbstractGeneratorScreen<T extends AbstractGeneratorContainer> extends ContainerScreen<T>{

	private ResourceLocation TEXTURE_GUI;

	protected int x;
	protected int y;

	public AbstractGeneratorScreen(T container, PlayerInventory playerInventory, ITextComponent title, ResourceLocation texLoc) {
		super(container, playerInventory, title);
		this.leftPos = 0;
		this.topPos = 0;
		this.imageWidth = 175;
		this.imageHeight = 166;
		this.TEXTURE_GUI = texLoc;
	}
